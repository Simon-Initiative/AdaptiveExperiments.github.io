...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> EASI</a></h1>
    </li>
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                  ...
                  <ul class="dropdown">
                        ...
                        <li><a  href="/support/">Research Support</a></li>
              ...
              <li class="has-dropdown">
                  ...
                  <ul class="dropdown">
                        ...
                        <li><a  href="/mooclet/">MOOClet</a></li>
    ...
    <div class="row">
        <div class="small-12 columns">
              ...
              <a id="logo" href="http://localhost:4000/" title="EASI – Experiments-As-A-Service-Infrastructure">
                  <img src="http://localhost:4000/assets/img/easi_new_logo.png" alt="EASI – Experiments-As-A-Service-Infrastructure">
              </a>
  ...
  <div id="footer">
    <div class="row">
      ...
      <div class="small-6 medium-3 large-3 columns">
        <img src="https://adaptiveexperiments.github.io/images/nsf-transparent.png" width="970"> <!-- add NSF logo IAC -->
